...
[continuous fleet occupancy](../coordination/continuous-fleet-occupancy.md) target that
...
3. When artifact authenticity is required, create and separately store an
   [artifact attestation](../identity/artifact-attestation.md); keep its HMAC key in the
...
[`examples/artifacts/safety_memory_quickstart.cpp`](../../../examples/artifacts/safety_memory_quickstart.cpp)
and

...
Library SemVer and storage schema numbers are independent. RBF-Safe 5.0 reads
every standalone format released by 0.x and never interprets a legacy
RapidBoxForest cache as RBF-Safe data.

| Format | Read | Write | Migration in 5.0 |
|---|---:|---:|---|
...
[Safety memory format](../assurance/memory/safety-memory-format.md). Its lifecycle history is
...
[Transactional safety memory](../assurance/memory/safety-memory-store.md). It adds immutable
...
[Versioned fleet schedules](../assurance/memory/fleet-schedule-archive.md). A v3.0 in-memory report
...
[Authenticated artifact attestations](../assurance/identity/artifact-attestation.md). No migration
...
[Policy calibration profiles](../applications/policy/policy-calibration.md). Existing policy
...
[Artifact transfer journal](../assurance/identity/artifact-transfer-journal-format.md). Existing
...
[Service trust bundles](../assurance/identity/service-trust-bundle-format.md). There is no implicit
...
[Service trust histories](../assurance/identity/service-trust-history-format.md). It is a new
...
[Service trust checkpoints](../assurance/identity/service-trust-checkpoint-format.md). No migration
...
[Reviewed deployment profiles](../assurance/identity/deployment-profile-format.md). No earlier
...
[Bounded execution sessions](../assurance/identity/bounded-execution-session-format.md). No earlier
...
[Revocation-aware execution ledger](../assurance/identity/execution-ledger-format.md). A bounded
...
[Deployment and runtime transparency](../assurance/identity/transparency-log-format.md). Neither a
...
[Verifiable provenance and external time](../assurance/identity/verifiable-provenance-format.md).
...
[Continuous fleet occupancy](../assurance/coordination/continuous-fleet-occupancy-format.md). A v3
...
[Continuous robot-scene occupancy format](../assurance/coordination/continuous-robot-scene-occupancy-format.md).
...
[Authenticated occupancy publication](../assurance/coordination/authenticated-occupancy-publication-format.md).
...
[Occupancy publication-history format](../assurance/coordination/occupancy-publication-history-format.md).
...
[Trust-rotating occupancy publication-history format](../assurance/coordination/rotating-occupancy-publication-history-format.md).
...
[Coordinated reservation agreement format](../assurance/coordination/coordinated-reservation-agreement-format.md).

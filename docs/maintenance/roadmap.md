...
- **v4.3 - Persistent and fork-audited occupancy streams:**
...
- **v4.6 - Unanimous coordinated occupancy reservation:**
  ...
  result remains `Unknown` and non-authorizing.
- **v4.7 - Original project scope closure:** public analytic
...
- **v5.0 (current) - Public header consolidation:** dependency-ordered Core,
  Envelope, Geometry, LECT, Atlas, Applications, and Assurance module headers;
  optional OMPL isolation; removal of legacy fine-grained include paths; and
  unchanged target, behavior, evidence, and storage-schema semantics.
- **v5.1+ candidates:** authenticated remote reservation-head exchange and

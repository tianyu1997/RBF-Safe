...
- Implementation: [`SafeIkSolver`](../../include/rbfsafe/modules/applications.h), with
...
- Verification: [`test_safe_ik.cpp`](../../tests/test_safe_ik.cpp) and the
  [Safe IK guide](../applications/planning/safe-ik.md).
...
- Implementation: [`RuntimeShield`](../../include/rbfsafe/modules/applications.h) and
  `LearningPolicySafetyGate`.
- Verification: [`test_shield.cpp`](../../tests/test_shield.cpp) and the
  [runtime shield guide](../applications/planning/runtime-shield.md).
...
- Verification: [`test_optimization.cpp`](../../tests/test_optimization.cpp) and
  the [optimization guide](../applications/planning/optimization.md).
...
- Verification:
  ...
  and the [MoveIt 2 guide](../applications/planning/moveit2.md).
...
- Plan claim: provide certified validity and RRT, RRT*, PRM, and BIT*
  integration.
- Implementation: optional [`RBFSafe::ompl`](../../include/rbfsafe/modules/ompl.h)
  validity, motion, sampler, roadmap, and planner interfaces.
- Verification: [`test_ompl.cpp`](../../tests/test_ompl.cpp) and the
  [OMPL adapter guide](../applications/planning/ompl-adapter.md).
...
- Implementation:
  [`TrajectoryAuditor`](../../include/rbfsafe/modules/atlas.h), deterministic region
  sequence, and explicit uncovered intervals.
- Verification: [`test_trajectory.cpp`](../../tests/test_trajectory.cpp) and the
  [trajectory auditor guide](../atlas/trajectory-auditor.md).
...
- Implementation: point FK, pose FK, analytic 6-by-N geometric Jacobian, and
  ...
  [`model.h`](../../include/rbfsafe/modules/geometry.h) and
  [`geometry.h`](../../include/rbfsafe/modules/geometry.h).
- Verification: analytic/finite-difference and 10,000-sample containment
  ...
  in [kinematics](../geometry/kinematics.md).
...
- Plan claim: deterministic adaptive partitioning and recursive corridor
  covering.
- Implementation: stable-path [`LectTree`](../../include/rbfsafe/modules/lect.h) and
  [`HipacCorridorBuilder`](../../include/rbfsafe/modules/applications.h).
...
- Implementation: [`AtlasUpdater`](../../include/rbfsafe/modules/applications.h), dependency
  envelopes, local repair domains, and immutable version stores.
- Verification: [`test_dynamic.cpp`](../../tests/test_dynamic.cpp) and the
  [dynamic update guide](../atlas/dynamic-updates.md).
...
- Implementation:
  [`EvidenceLevel`](../../include/rbfsafe/modules/geometry.h) and subject-bound
  deterministic certificates.
- Verification: execution tests and the [safety model](../core/safety-model.md);
...
- Implementation:
  [`RegionDatabase`](../../include/rbfsafe/modules/applications.h) with all six
  geometry families and subject-bound certificates.
- Verification:
  [`test_region_database.cpp`](../../tests/test_region_database.cpp) and the
  [region database guide](../applications/planning/region-database.md).

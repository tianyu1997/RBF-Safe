...
[kinematics](../geometry/kinematics.md) for the modified-DH convention.
...
Include `<rbfsafe/modules/assurance.h>` and link `RBFSafe::occupancy`.
...
[the complete contract](../assurance/coordination/continuous-fleet-occupancy.md)
and [storage format](../assurance/coordination/continuous-fleet-occupancy-format.md).
...
[the complete contract](../assurance/coordination/continuous-moving-obstacles.md) and
[storage format](../assurance/coordination/continuous-robot-scene-occupancy-format.md).
...
[the complete contract](../assurance/coordination/authenticated-occupancy-publication.md) and
[storage format](../assurance/coordination/authenticated-occupancy-publication-format.md).
...
[the complete contract](../assurance/coordination/occupancy-publication-history.md) and
[storage format](../assurance/coordination/occupancy-publication-history-format.md).
...
[the complete contract](../assurance/coordination/rotating-occupancy-publication-history.md) and
[storage format](../assurance/coordination/rotating-occupancy-publication-history-format.md).
...
[the complete contract](../assurance/coordination/coordinated-reservation-agreements.md) and
[storage format](../assurance/coordination/coordinated-reservation-agreement-format.md).

## Revocation-aware execution ledger

Include `<rbfsafe/modules/assurance.h>` and link `RBFSafe::execution`.
...
[the schema-1 format and safety contract](../assurance/identity/execution-ledger-format.md).

## Deployment and runtime transparency

Include `<rbfsafe/modules/assurance.h>` and link `RBFSafe::transparency`.
...
[the transparency format and trust boundary](../assurance/identity/transparency-log-format.md).

## Witnessed transparency and checkpoint gossip

Include `<rbfsafe/modules/assurance.h>` and link `RBFSafe::witness`.
...
[witnessed transparency and gossip](../assurance/identity/witnessed-transparency.md).

## Verifiable provenance and external time

Include `<rbfsafe/modules/assurance.h>` and link `RBFSafe::provenance`.
...
[the provenance trust boundary](../assurance/identity/verifiable-provenance.md).

## Reviewed deployment profiles

Include `<rbfsafe/modules/assurance.h>` and link `RBFSafe::deployment`.
...
See [bounded execution sessions](../assurance/identity/bounded-execution-session-format.md).
...
Include `<rbfsafe/modules/applications.h>` and link `RBFSafe::update`.
...
[dynamic updates](../atlas/dynamic-updates.md).
...
[trajectory auditor guide](../atlas/trajectory-auditor.md) for precise semantics.
...
Include `<rbfsafe/modules/ompl.h>` and link `RBFSafe::ompl`. `make_ompl_state_space`
...
audits every returned path. See the [OMPL adapter guide](../applications/planning/ompl-adapter.md).

## Certified planning primitives

Include `<rbfsafe/modules/applications.h>` and link `RBFSafe::planning`.
...
Include `<rbfsafe/modules/applications.h>` and link `RBFSafe::corridor`.
...
[corridor guide](../applications/planning/corridors.md) and [corridor schema](../applications/planning/corridor-format.md).

## Safe IK

Include `<rbfsafe/modules/applications.h>` and link `RBFSafe::ik`.
...
`CertifiedConnectivity` route as separate claims. See [Safe IK](../applications/planning/safe-ik.md).

## Generalized region database

Include `<rbfsafe/modules/applications.h>` and link `RBFSafe::regions`.
...
accepts only AABB/OBB parents. See the [region database guide](../applications/planning/region-database.md)
and [format specification](../applications/planning/region-database-format.md).

## Optimization consumers

Include `<rbfsafe/modules/applications.h>` and link `RBFSafe::optimization`.
...
Include `<rbfsafe/modules/applications.h>` and link `RBFSafe::shield`.
...
[runtime shield guide](../applications/planning/runtime-shield.md) for complete semantics and limits.

## Learning-policy safety

Include `<rbfsafe/modules/applications.h>` and link `RBFSafe::policy`.
...
authorization. See [learning-policy safety](../applications/policy/policy-safety.md) and the
[feedback format](../applications/policy/policy-feedback-format.md).
...
See [policy calibration](../applications/policy/policy-calibration.md).
...
[policy calibration drift and lifecycle](../applications/policy/policy-calibration-lifecycle.md).

## Persistent safety memory and fleets

Include `<rbfsafe/modules/assurance.h>` and link `RBFSafe::memory`.
...
execution authorization. See [persistent safety memory](../assurance/memory/safety-memory.md) and
the [memory format](../assurance/memory/safety-memory-format.md). Multi-process deployments should
also read the [transactional store contract](../assurance/memory/safety-memory-store.md) and
[fleet archive contract](../assurance/memory/fleet-schedule-archive.md).

## Artifact authentication

Include `<rbfsafe/modules/assurance.h>` and link `RBFSafe::trust`.
...
[authenticated artifact attestations](../assurance/identity/artifact-attestation.md).

## Remote artifact transfers

Include `<rbfsafe/modules/assurance.h>` and link `RBFSafe::remote`.
...
See the
[remote artifact service contract](../assurance/identity/remote-artifact-service.md) and
[journal format](../assurance/identity/artifact-transfer-journal-format.md).

## Public-key service identities

Include `<rbfsafe/modules/assurance.h>` and link `RBFSafe::identity`.
...
[public-key service identities](../assurance/identity/public-service-identities.md), the
[trust-bundle format](../assurance/identity/service-trust-bundle-format.md), and the
[trust-history format](../assurance/identity/service-trust-history-format.md), and the
[trust-checkpoint format](../assurance/identity/service-trust-checkpoint-format.md).

...
certificate. See [kinematics](../geometry/kinematics.md) for conventions and error
behavior.
...
[corridor guide](../applications/planning/corridors.md).
...
Pose convergence is point-checked evidence. Read the [Safe IK guide](../applications/planning/safe-ik.md)
...
Read the [trajectory auditor guide](../atlas/trajectory-auditor.md) before interpreting
`PARTIAL` or `INVALID`.
...
[dynamic updates](../atlas/dynamic-updates.md) before using certificate inheritance or
rollback.
...
validated artifact. Read [persistent safety memory](../assurance/memory/safety-memory.md) before
...
overwritten. See [transactional safety memory](../assurance/memory/safety-memory-store.md).
...
RBF-Safe. Read the
[remote artifact service contract](../assurance/identity/remote-artifact-service.md) before using
this boundary.
...
[public-key service identities](../assurance/identity/public-service-identities.md).
...
execution certificate. See [versioned fleet schedules](../assurance/memory/fleet-schedule-archive.md).
...
never authorizes execution. See [policy calibration](../applications/policy/policy-calibration.md).
...
execution. See
[revocation-aware execution ledger](../assurance/identity/execution-ledger-format.md).
...
[deployment and runtime transparency](../assurance/identity/transparency-log-format.md) and
...
See [continuous-time fleet occupancy](../assurance/coordination/continuous-fleet-occupancy.md).
...
[continuous moving-obstacle occupancy](../assurance/coordination/continuous-moving-obstacles.md).
...
[occupancy publication histories](../assurance/coordination/occupancy-publication-history.md) and the
[schema-1 format](../assurance/coordination/occupancy-publication-history-format.md).
...
`examples/coordination/rotating_occupancy_publication_history_quickstart.cpp` and
`.py`. See the
[trust-rotating history contract](../assurance/coordination/rotating-occupancy-publication-history.md)
and [schema-1 format](../assurance/coordination/rotating-occupancy-publication-history-format.md).
...
See [the agreement contract](../assurance/coordination/coordinated-reservation-agreements.md) and
[schema-1 format](../assurance/coordination/coordinated-reservation-agreement-format.md).
